...
![Demo Video](research/assets/demo.gif)
...
- [x] **Phase 2: Complete Opcode Set** (Implementing all 35 CHIP-8 opcodes, timers)
- [x] **Phase 3: GUI & I/O** (SDL/Graphics library integration and keypad support, and sound)
